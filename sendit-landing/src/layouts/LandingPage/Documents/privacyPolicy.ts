  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "Account information is kept until account deletion. Transaction history is kept for 5 years (legal requirement). Chat messages are kept for 1 year. ID verification data is kept for 1 year after account closure. Location data is kept for 90 days."
        ]
      },
      {
        id: "p7",
