import { logo3, package as package_, luggage } from "../../assets/images/index.ts";
...
const Footer = () => {
    ...
    return (
        <div className="relative flex flex-col justify-center items-center text-center w-full text-white pt-10 bg-[#010413] overflow-hidden">
            ...
            {/* Background Images: Full opacity (removed opacity-60) and explicit high z-index (z-30) */}
            <img src={package_} alt="Package" className="absolute w-[18vw] sm:w-[20vw] bottom-0 left-0 z-30 pointer-events-none" />
            <img src={luggage} alt="Luggage" className="absolute w-[18vw] sm:w-[20vw] right-0 bottom-0 z-30 pointer-events-none" />
